...
#plt.plot(learning_rates[:], accuracy_values, label='Accuracy')
plt.xlabel('Learning Rates')
plt.ylabel('Loss')
plt.legend()
plt.xticks(learning_rates)  # Set the x-axis tick values
#plt.ticklabel_format(axis='x', style='sci', scilimits=(0,0))  # Set x-axis labels to scientific notation
plt.show()
...
# Définir les emplacements des ticks et les libellés correspondants sur l'axe des x
...
# Tracé des courbes de MSE et MAE pour chaque learning rate
plt.plot(learning_rates, mse_values, label='MSE')
plt.plot(learning_rates, mae_values, label='MAE')

# Configuration du graphique
plt.title('MSE and MAE vs. Learning Rate')
